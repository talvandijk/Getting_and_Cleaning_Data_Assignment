...
-   run\_analysis.R : the R script which reads all relevant datasets and variable labels and manipulates, merges and 
    summarizes data
-   codebook.md : a Markdown document containing all variable names in the first and the second tidy dataset
-   readme.md : this Markdown document
-   allmerge\_tidy.csv : the first tidy dataset containing variables for identification of test subject and activity as well as     means and standard deviations of the measurements
-   allmerge\_aggregated.csv : the second tidy dataset, which provides for each of the 30 test subjects for each activity they
    performed averages of all measurement variables in the first tidy dataset
